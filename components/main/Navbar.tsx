  ...
  return (
    <>
      ...
      <header
        ...
        `}
      >
        <div className="w-full h-full max-w-[1400px] mx-auto flex flex-row items-center justify-between px-4 md:px-10">
          {/* Left: logo + name */}
          ...
          <nav className="hidden md:flex flex-row items-center justify-center">
            <div className="flex items-center gap-1 rounded-full border border-[#7042f861] bg-[#0300145e] px-6 py-2">
